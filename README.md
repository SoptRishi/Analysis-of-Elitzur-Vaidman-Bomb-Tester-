...
I have removed the installation/run instructions and added a dedicated **Simulation Results** section with placeholders for your images and brief explanations for each graph.
...
<img src="single_iteration.png" width="700" alt="for single iteration">
...
<img src="zeno_plot.png" width="700" alt="zeno effect">

### 3. Theoretical Efficiency Limit

This trend line plots the theoretical limit of Interaction-Free Measurement efficiency. The curve shows that efficiency scales non-linearly with the number of cycles, asymptotically approaching 100%. This serves as the ideal baseline against which our stochastic quantum simulations are validated.
<img src="limit_comparision.png" width="700" alt="efficiency limit">
